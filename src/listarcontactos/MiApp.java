...
public class MiApp {
    ...
    public static void main(String[] args) {
        ...
        /**
         * Se llama al metodo introducirDatosPropietarios de la clase Libreta Se
         * solicita los datos del creador de la libreta Este método tambien crea
         * el Array de contactos vacios
         */
        ...
        do {
            ...
            /**
             * @param seguir parametro que si es 1 vuelve a comenzar el Menú,
             * sino se finaliza
             */
