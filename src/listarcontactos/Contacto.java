...
public class Contacto {
    /**Variables privadas que van hacer referenia a los datos necesarios para crear un contacto
     nombre, apeelido, email, telefono y un identificador llamado ID*/
    ...
    /** constructor de la clase con parameto ID. Es necesario para diferenciar cada elemento del array
     * Para poder establecer que elemento esta libre y cuales son NULL
     * @param ID*/
 ...
 * 
     * @return devuelve todos los parametros de la clase contacto con sus valores en una cadena de caracteres*/
    @Override
